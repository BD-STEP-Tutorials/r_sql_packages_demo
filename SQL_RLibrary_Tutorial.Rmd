...
``` {sql, connection = con, output.var = "PATIENT_COHORT_1"}
SELECT 
  patient.patient, patient.birthdate, patient.race, patient.ethnicity, patient.gender, encounter.DESCRIPTION as encounter_description, encounter.REASONDESCRIPTION as notes
FROM 
   [synthetic.patients] as patient
LEFT JOIN
   [synthetic.encounters] as encounter ON encounter.PATIENT = patient.patient
WHERE 
   patient.gender like 'M'
```
